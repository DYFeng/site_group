...
<?php
		...
		function createContent() {
			...
			if( get_option('easy_privacy_acknowlegement') == true ) {
				$content = $content.'<span style="font-size:11px;">This policy was generated by Easy Privacy Policy Plugin <a target="_blank" href="http://raccarinsurance.me.uk/">rac car insurance</a> for WordPress.</span>';
			}
